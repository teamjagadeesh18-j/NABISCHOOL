...
export default function ConnectSection() {
  ...
  return (
    <section id="connect" className="py-20 md:py-28 px-4 sm:px-6 md:px-8 bg-[#f7f6f2] border-t border-[#e2e8f0] relative overflow-hidden">
      <div 
        className="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 rounded-full pointer-events-none blur-3xl opacity-20"
        style={{ backgroundColor: "rgba(22, 78, 156, 0.15)" }}
      />
      ...
      <div className="max-w-[1280px] mx-auto space-y-14 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 text-left">
          <div className="max-w-2xl space-y-3">
            <span 
              ...
              style={{
                backgroundColor: "rgba(22, 78, 156, 0.08)",
                color: "#164E9C",
                borderColor: "rgba(22, 78, 156, 0.2)"
              }}
            >
              CONTACT & ADMISSIONS
            </span>
            <TextEffect 
              ...
              speedReveal={1.1} 
              speedSegment={0.3} 
              className="text-3xl md:text-5xl font-extrabold text-[#001f1f] font-heading tracking-tight leading-tight"
            >
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="space-y-4 lg:col-span-4 font-body">
            ...
            <div 
              className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group"
              style={{ borderLeftWidth: "4px", borderLeftColor: "#164E9C" }}
            >
              <div className="flex items-start gap-4">
                <MapPin className="w-5 h-5 shrink-0 mt-0.5" style={{ color: "#164E9C" }} />
                <div className="min-w-0 flex-1">
                  <TextEffect as="h4" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="font-extrabold text-[#001f1f] text-sm font-heading">Campus Address</TextEffect>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-sm hover:shadow-md transition-all duration-300 flex items-start gap-4 group">
              <div 
                ...
                style={{
                  backgroundColor: "rgba(22, 78, 156, 0.1)",
                  borderColor: "rgba(22, 78, 156, 0.25)",
                  color: "#164E9C"
                }}
              >
              ...
              <div className="min-w-0 flex-1">
                <TextEffect as="h4" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="font-extrabold text-[#001f1f] text-sm font-heading">Phone Enquiries</TextEffect>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-sm hover:shadow-md transition-all duration-300 space-y-2">
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4" style={{ color: "#164E9C" }} />
                <TextEffect as="h4" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="font-extrabold text-[#001f1f] text-sm font-heading">Email Communication</TextEffect>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden flex items-start gap-4">
              <Clock className="w-5 h-5 shrink-0 mt-0.5" style={{ color: "#164E9C" }} />
              <div className="min-w-0 flex-1 relative z-10">
                <TextEffect as="h4" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="font-extrabold text-[#001f1f] text-sm font-heading">Office Hours</TextEffect>
          ...
          <div className="lg:col-span-8">
            <div 
              className="p-8 md:p-10 rounded-2xl bg-white border border-[#e2e8f0] font-body relative overflow-hidden"
              style={{
                boxShadow: `0 12px 40px -10px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.8)`
              }}
            >
              <div className="absolute top-0 left-0 right-0 h-1" style={{ backgroundColor: "#164E9C" }} />

              <TextEffect as="h3" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-2xl font-extrabold text-[#001f1f] font-heading mb-6">Send Quick Inquiry</TextEffect>
              ...
              {submitted ? (
                ...
                >
                  <CheckCircle2 className="w-10 h-10 mx-auto" style={{ color: "#164E9C" }} />
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-3.5 rounded-2xl text-white font-bold text-sm transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] cursor-pointer"
                    style={{
                      backgroundColor: "#164E9C",
                      boxShadow: `0 10px 25px -5px rgba(22, 78, 156, 0.4), inset 0 1px 0 rgba(255,255,255,0.3)`
                    }}
                  >
