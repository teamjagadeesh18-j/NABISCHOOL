...
export default function FAQs() {
  ...
  return (
    <section id="faqs" className="py-20 md:py-28 bg-[#f7f6f2] border-t border-[#e2e8f0] font-body relative overflow-hidden">
        ...
        <div className="grid gap-12 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <TextEffect 
              ...
              speedReveal={1.1} 
              speedSegment={0.3} 
              className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#001f1f] font-heading tracking-tight leading-tight"
            >
            ...
            >
              <h4 className="font-extrabold text-sm text-[#001f1f] font-heading">Need Direct Guidance?</h4>
          ...
          <div className="lg:col-span-7">
            <div 
              className="p-6 md:p-8 rounded-2xl bg-white border border-[#e2e8f0]"
              style={{
            ...
            >
              <Accordion type="single" collapsible className="space-y-3">
                {faqItems.map((item) => (
                  ...
                  >
                    <AccordionTrigger 
                      className="cursor-pointer text-left text-sm md:text-base font-extrabold text-[#001f1f] hover:no-underline font-heading py-4"
                    >
                      {item.question}
                    </AccordionTrigger>
