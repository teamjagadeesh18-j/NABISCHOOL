...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8f9] text-[#475569] antialiased font-body">
      <SpatialHeader />
      <BreadcrumbSchema pageName="Contact" pageUrl="https://nabicrescent.edu.in/contact" />
    ...
    <div className="bg-[#ffffff] border-b border-[#e2e8f0] py-3 px-6 text-xs text-[#64748b]">
      ...
      <section className="bg-[#0f172a] text-white py-16 px-6 text-center">
        <div className="max-w-[1200px] mx-auto space-y-4">
          <span className="inline-block px-3.5 py-1 rounded-full bg-[#004d40] text-white text-xs font-semibold uppercase tracking-wider">
            GET IN TOUCH
          </span>
          <TextEffect as="h1" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-3xl md:text-5xl font-bold font-heading text-white">
            Contact Nabi Crescent Matriculation School
          </TextEffect>
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#e2e8f0] shadow-sm space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eeeffc] text-[#004d40] flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-xs text-[#64748b] mt-1 leading-relaxed">6/14, Pillayar Koil St, Arundhati Palaiyam, Avadi 600054</TextEffect>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-xs text-[#64748b] mt-1">+91 44 4378 0320 (Primary Desk)</TextEffect>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-xs text-[#64748b] mt-1">info@nabicrescentmatriculationschool.edu.in</TextEffect>
                </div>
              </div>
            ...
            <div className="pt-4 border-t border-[#e2e8f0]">
              <a 
                href="https://wa.me/91914443780320" 
                target="_blank" 
                rel="noreferrer"
        ...
        <div className="bg-white p-8 rounded-3xl border border-[#e2e8f0] shadow-sm space-y-6">
          ...
          {formSubmitted ? (
            <div className="p-6 bg-[#f0fdf4] border border-[#bbf7d0] rounded-2xl text-center space-y-3">
              ...
              <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-xs text-[#166534]">Thank you for contacting Nabi Crescent Matriculation School. Our administrative office will get back to you shortly.</TextEffect>
              <button onClick={() => setFormSubmitted(false)} className="text-xs font-bold text-[#004d40] underline mt-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-[#cbd5e1] text-xs focus:outline-none focus:border-[#004d40]"
                />
              </div>
              ...
              <button 
                type="submit"
                className="w-full py-3 rounded-xl bg-[#004d40] text-white font-bold text-sm shadow-md hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
              >
      ...
      <section className="py-12 px-6 bg-[#0f172a] text-white">
        <div className="max-w-[1200px] mx-auto text-center space-y-6">
          <span className="px-3.5 py-1 rounded-full bg-[#004d40] text-white text-xs font-semibold uppercase">
          ...
          <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-sm text-[#94a3b8] max-w-xl mx-auto">6/14, Pillayar Koil St, Arundhati Palaiyam, Avadi 600054</TextEffect>
          <div className="pt-2">
            <a 
              href="https://maps.google.com/?q=13.11626,80.10805" 
              target="_blank" 
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#004d40] text-white font-bold text-sm shadow-md hover:opacity-90"
            >
