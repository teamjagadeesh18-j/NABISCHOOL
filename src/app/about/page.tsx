          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-[#e2e8f0]">
              <div className="p-3 bg-[#f8fafc] rounded-xl border border-[#e2e8f0]">
                <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-2xl font-bold text-[#0f172a] font-heading">1991</TextEffect>
      ...
      <section className="py-16 px-6 bg-[#0f172a] text-white">
        <div className="max-w-[1000px] mx-auto bg-[#1e293b] p-8 md:p-12 rounded-3xl border border-[#334155] shadow-xl text-center space-y-6">
          ...
          <div>
            ...
            <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-xs text-[#94a3b8]">Nabi Crescent Matriculation School, 6/14</TextEffect>
          </div>
        </div>
      </section>
