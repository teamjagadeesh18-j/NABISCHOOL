...
export function Footer() {
  const schoolName = "Nabi Crescent Matriculation School".replace("dav-matriculation-higher-secondary-school---avadi (2)", "DAV Matriculation Higher Secondary School");
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="flex items-center gap-3 text-xs text-slate-400 font-medium pt-2">
              <MapPin className="w-4 h-4 shrink-0" style={{ color: "#164E9C" }} />
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <Phone className="w-4 h-4 shrink-0" style={{ color: "#164E9C" }} />
                <span>+91 98401 55667 Desk Enquiries</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <Mail className="w-4 h-4 shrink-0" style={{ color: "#164E9C" }} />
