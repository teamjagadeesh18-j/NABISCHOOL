      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="text-[#001f1f] text-3xl md:text-4xl font-bold font-heading">Frequently Asked Questions</h2>
            <p className="text-[#5c7070] mt-4 text-balance text-base md:text-lg">
              Everything you need to know about Nabi Crescent Matriculation School.
            </p>
            <p className="text-[#5c7070] mt-6 hidden md:block text-sm">
          ...
          <p className="text-[#5c7070] mt-6 md:hidden text-sm">
