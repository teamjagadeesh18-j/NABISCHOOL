...
export default function AcademicsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8f9] text-[#475569] antialiased font-body">
      <SpatialHeader />
      <BreadcrumbSchema pageName="Academics" pageUrl="https://nabicrescent.edu.in/academics" />
    ...
    <div className="bg-[#ffffff] border-b border-[#e2e8f0] py-3 px-6 text-xs text-[#64748b]">
      ...
      <section className="bg-[#0f172a] text-white py-16 px-6 relative text-center">
        <div className="max-w-[1200px] mx-auto space-y-4">
          ...
          <p className="text-base md:text-lg text-[#94a3b8] max-w-2xl mx-auto leading-relaxed">
            Empowering students of Nabi Crescent Matriculation School with strong conceptual foundations, Samacheer Kalvi standards, and special exam preparation.
          </p>
        </div>
      </section>
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl border border-[#e2e8f0] shadow-sm space-y-8">
          {activeTab === 'kindergarten' && (
            <div className="space-y-6">
              <span className="px-3 py-1 bg-[#eeeffc] text-[#004d40] font-semibold text-xs rounded-full">FOUNDATIONAL EARLY YEARS</span>
          ...
          {activeTab === 'primary' && (
            <div className="space-y-6">
              <span className="px-3 py-1 bg-[#eeeffc] text-[#004d40] font-semibold text-xs rounded-full">PRIMARY YEARS (CLASSES 1 TO 5)</span>
          ...
          {activeTab === 'middle' && (
            <div className="space-y-6">
              <span className="px-3 py-1 bg-[#eeeffc] text-[#004d40] font-semibold text-xs rounded-full">MIDDLE STAGE (CLASSES 6 TO 8)</span>
          ...
          {activeTab === 'secondary' && (
            <div className="space-y-6">
              <span className="px-3 py-1 bg-[#eeeffc] text-[#004d40] font-semibold text-xs rounded-full">BOARD PREPARATION (CLASSES 9 & 10)</span>
          ...
          {activeTab === 'higher' && (
            <div className="space-y-6">
              <span className="px-3 py-1 bg-[#eeeffc] text-[#004d40] font-semibold text-xs rounded-full">HIGHER SECONDARY (CLASSES 11 & 12)</span>
      ...
      <section className="py-12 px-6 bg-white text-center border-t border-[#e2e8f0]">
        <div className="max-w-xl mx-auto space-y-4">
          ...
          <a href="/admissions" className="inline-block px-6 py-3 rounded-xl bg-[#004d40] text-white font-semibold text-sm shadow-md hover:opacity-90">
            Apply Online Now
          </a>
        </div>
      </section>
