    ...
    <div className="bg-[#ffffff] border-b border-[#e2e8f0] py-3 px-6 text-xs text-[#64748b]">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#64748b] mt-1 leading-relaxed">6/14, Pillayar Koil St, Arundhati Palaiyam, Avadi 600054</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#64748b] mt-1">+91 44 4378 0320 (Primary Desk)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#64748b] mt-1">info@nabicrescentmatriculationschool.edu.in</p>
                </div>
              </div>
        ...
        <div className="bg-white p-8 rounded-3xl border border-[#e2e8f0] shadow-sm space-y-6">
          ...
          {formSubmitted ? (
            <div className="p-6 bg-[#f0fdf4] border border-[#bbf7d0] rounded-2xl text-center space-y-3">
              ...
              <p className="text-xs text-[#166534]">Thank you for contacting Nabi Crescent Matriculation School. Our administrative office will get back to you shortly.</p>
      ...
      <section className="py-12 px-6 bg-[#0f172a] text-white">
        <div className="max-w-[1200px] mx-auto text-center space-y-6">
          ...
          <p className="text-sm text-[#94a3b8] max-w-xl mx-auto">6/14, Pillayar Koil St, Arundhati Palaiyam, Avadi 600054</p>
          <div className="pt-2">
            <a 
