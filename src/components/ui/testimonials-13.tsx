...
export default function Testimonials13({
  ...
  return (
    <div className="px-6 py-20 max-w-7xl mx-auto overflow-hidden">
      <TextEffect as="h2" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-[#001f1f]nter font-bold text-[#001f1f]xl tracking-tight md:text-[#001f1f]xl font-heading">
        {title}
      </TextEffect>
      <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="mt-3 text-[#001f1f]nter text-muted-foreground text-[#001f1f]se md:text-lg font-body max-w-2xl mx-auto">
        {subtitle}
      </TextEffect>
  ...
  items.map((testimonial) => {
    ...
    return (
      <div
        ...
        key={testimonial.id}
      >
        <div className="rounded-xl border bg-[#ffffff]kground p-6 shadow-xs flex flex-col justify-between h-full">
          <div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Avatar className="size-10">
                  <AvatarFallback className="bg-[#172554] text-[#F4B400] font-bold text-[#001f1f]se font-heading">
                    {initial}
                  </AvatarFallback>
                </Avatar>
                <div>
              ...
              <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-[#ffffff]mber-400/20 text-[#001f1f]mber-600 font-body">
                Verified
              </span>
            </div>
