...
export default function ConnectSection() {
  ...
  return (
    <section id="connect" className="py-20 px-6 bg-[#f0fdf4] border-t border-[#dcfce7]">
      <div className="max-w-[1200px] mx-auto space-y-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-4 lg:col-span-1 font-body">
            ...
            {/* Campus Address Card */}
            <div className="p-6 rounded-2xl bg-white border border-[#dcfce7] shadow-sm flex items-start gap-4">
              <div className="p-3 rounded-full bg-[#dcfce7] text-[#065f46] shrink-0">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#064e3b] mb-1">Parent's Full Name *</label>
                      <input required type="text" placeholder="e.g. Ramesh Kumar" className="w-full px-4 py-2.5 rounded-full border border-[#dcfce7] bg-slate-50 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600" />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-[#064e3b] mb-1">Mobile Number *</label>
                      <input required type="tel" placeholder="+91 98765 43210" className="w-full px-4 py-2.5 rounded-full border border-[#dcfce7] bg-slate-50 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600" />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#064e3b] mb-1">Student's Name</label>
                      <input type="text" placeholder="e.g. Ananya" className="w-full px-4 py-2.5 rounded-full border border-[#dcfce7] bg-slate-50 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600" />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-[#064e3b] mb-1">Class Applying For *</label>
                      <select required className="w-full px-4 py-2.5 rounded-full border border-[#dcfce7] bg-slate-50 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#064e3b] mb-1">Your Message / Query</label>
                    <textarea rows={3} placeholder="Ask any question about admissions, fee structure, or bus transport..." className="w-full px-4 py-2.5 rounded-2xl border border-[#dcfce7] bg-slate-50 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600"></textarea>
                  </div>
                  <button type="submit" className="w-full py-3.5 rounded-full bg-[#065f46] text-white text-sm font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-sm font-body cursor-pointer">
            ...
            <div className="rounded-2xl border border-[#dcfce7] overflow-hidden shadow-sm h-[220px] relative">
              <iframe 
                title="Nabi Crescent Matriculation School Location Map" 
