...
export default function Testimonials13({
  ...
  return (
    <div className="px-6 py-20 max-w-7xl mx-auto overflow-hidden">
      <h2 className="text-[#001f1f]nter font-bold text-[#001f1f]xl tracking-tight md:text-[#001f1f]xl font-heading">
        {title}
      </h2>
      <p className="mt-3 text-[#001f1f]nter text-muted-foreground text-[#001f1f]se md:text-lg font-body max-w-2xl mx-auto">
        {subtitle}
      </p>
