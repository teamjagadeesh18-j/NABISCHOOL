  ...
  return (
    <section className={`w-full ${config.themeBg} py-20 md:py-28 px-4 sm:px-6 md:px-8 border-t border-b ${config.border} font-body relative overflow-hidden`}>
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          <div className="absolute top-0 left-0 right-0 h-1.5" style={{ backgroundColor: "#164E9C" }} />
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center relative z-10">
            <div className="lg:col-span-8 space-y-6">
              <TextEffect 
                ...
                speedReveal={1.1} 
                speedSegment={0.3} 
                className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#001f1f] font-heading leading-tight tracking-tight"
              >
                {config.heading}
              </TextEffect>
              ...
              <div className="pt-4 flex items-center gap-4">
                ...
                <div>
                  <TextEffect as="h4" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-base font-extrabold text-[#001f1f] font-heading">
            ...
            >
              <span 
                ...
                style={{ color: "#164E9C", borderColor: "#e2e8f0" }}
              >
